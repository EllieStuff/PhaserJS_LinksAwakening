...
class InputManager extends Phaser.GameObjects.Sprite {
    constructor(_scene){
        ...
        this.Inputs = [
            ...
            _scene.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.J),
    ...
    GetKeyDown(_keyCode){
        if(!this.hasCopiedKeyDown){
            ...
            this.keyDownCopy = [
                ...
                Phaser.Input.Keyboard.JustDown(this.Inputs[this.KeyCodes.J]),
    ...
    GetKeyUp(_keyCode){
        if(!this.hasCopiedKeyUp){
            ...
            this.keyUpCopy = [
                ...
                Phaser.Input.Keyboard.JustUp(this.Inputs[this.KeyCodes.J]),
